...
summary: 'Créer une nouvelle sauvegarde d"application pour une application' 
---
= Créer une nouvelle sauvegarde d'application pour une application
:allow-uri-read: 


[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/accounts/{account_id}/k8s/v1/apps/{app_id}/appBackups`#

Indique les valeurs souhaitées pour la ressource d'API de sauvegarde d'application à créer.
